...
public class ValidarPlan {
    ...
    /*
        ...
        Se debe validar y retornar false si:
            ...
            - No se permite un año con el att plan != del plan que se recibe [ej. plan.getAnios().get(0).getPlan().equals(plan) == false, es error ] ?? que
            - Los numeros de los años en el listado de años debe ser secuencial, comenzando en 1
           ...
           - No se permite una materia con el att anioPlan != del anioPlan al q pertenece [ej. anioPlan.getMaterias().get(0).getAnioPlan().equals(anioPlan) == false, es error ]  
            ...
            - No se permiten años con un listado de materias null o vacio, excepto si el estado del plan es BORRADOR materia tiene un att anioplan tmb
